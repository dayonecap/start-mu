...
export const establishmentDe: Record<string, Partial<ServiceEntry>> = {
  "domestic-company": {
    ...
    facts: [
      ...
      { label: "Steuern", value: "15 % auf das steuerpflichtige Einkommen. Keine Kapitalertragsteuer. An Gesellschafter gezahlte Dividenden sind bei diesen steuerfrei" },
...
export const faqsBusinessDe: Record<string, Faq[]> = {
  "domestic-company": [
    ...
    { q: "Wie wird die Gesellschaft besteuert?", a: "Mit 15 % auf das steuerpflichtige Einkommen, mit Teilbefreiungen für bestimmte Einkunftsarten. Es gibt keine Kapitalertragsteuer, und Dividenden sind beim Gesellschafter steuerfrei." },
