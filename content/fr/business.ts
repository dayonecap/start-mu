...
export const establishmentFr: Record<string, Partial<ServiceEntry>> = {
  "domestic-company": {
    ...
    facts: [
      ...
      { label: "Fiscalité", value: "15 % sur le revenu imposable. Pas d'impôt sur les plus-values. Les dividendes versés aux actionnaires sont exonérés d'impôt sur le revenu entre leurs mains" },
...
export const faqsBusinessFr: Record<string, Faq[]> = {
  "domestic-company": [
    ...
    { q: "Comment la société est-elle imposée ?", a: "À 15 % sur le revenu imposable, avec des exonérations partielles pour certaines catégories. Il n'y a pas d'impôt sur les plus-values et les dividendes sont exonérés d'impôt sur le revenu entre les mains de l'actionnaire." },
