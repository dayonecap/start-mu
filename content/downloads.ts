...
export const checklistPack = localised("start-mu-document-checklists", { en: 25, fr: 25, de: 27 });
...
export const checklists: Record<string, LocalisedDownload> = {
  ...
  "residency/golden-visa": localised("start-mu-checklist-golden-visa", { en: 2, fr: 2, de: 2 }),
